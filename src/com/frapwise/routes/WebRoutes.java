...
public final static String HOME 					= "home.htm";
	...
	public final static String ADMIN_DASHBOARD 			= "admin-dashboard.htm";
		...
		public final static String ADMIN_EDIT_MAX_LEAVE			= "admin-edit-max-leave.htm";
		public final static String ADMIN_EDIT_MAX_LEAVE_DB		= "admin-edit-max-leave-db.htm";
